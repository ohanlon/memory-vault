  ...
  extensions: [
    {
      ...
      renderer(token: Tokens.Generic) {
        return `<a href="#" class="md-wikilink" data-wikilink="${escapeHtml(token.target as string)}">${escapeHtml(token.display as string)}</a>`;
      },
    },
    {
      name: "hashtag",
...
export function MarkdownPreview({ content, onSelectTitle, onOpenExternal }: Props) {
  const html = useMemo(() => {
